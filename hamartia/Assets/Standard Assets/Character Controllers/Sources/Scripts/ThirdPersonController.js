...
public var jumpPoseAnimation : AnimationClip;	
	*/
	...
	if(!climbAnimation) {
		_animation = null;
		Debug.Log("No climb animation found. Turning off animations.");
	}
...
function OnLadder () {
	...
	Rotation(transform, Vector3.right * -90.0, .5);
	//gameObject.use.Rotation(transform, Vector3.forward * 90.0, .1);
	//Rotate Player to ladder degrees
